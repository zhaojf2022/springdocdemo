...
class JPAUnitTest {
    ...
    @Test
    void should_find_no_todos_if_repository_is_empty() {
    ...
    void should_store_a_tutorial() {
        ...
        assertThat(todo).hasFieldOrPropertyWithValue("title", "Todo title")
                        .hasFieldOrPropertyWithValue("description", "Todo desc");
    }
    ...
    @Test
    void should_find_todos_by_title_containing_string() {
